...
class SetBudget extends StatefulWidget {
  const SetBudget({super.key, required this.title});
  final String title;
  @override
...
class _SetBudgetState extends State<SetBudget> {
  ...
  void _submitExpense() {
    ...
    try {
      ...
      Provider.of<Data>(context, listen: false).dining = 0;
      Provider.of<Data>(context, listen: false).entertainment = 0;
      Provider.of<Data>(context, listen: false).investment = 0;
